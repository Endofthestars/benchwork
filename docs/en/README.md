...
# Benchwork documentation

[English](README.md) | [Simplified Chinese](../zh-CN/README.md)

English is the canonical source for all Benchwork documentation.
...
- [Athanor Foundation](architecture/ATHANOR.md)
- [Circle and Ward](architecture/CIRCLE.md)
