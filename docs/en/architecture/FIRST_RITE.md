...
`computational-study@0.2.0` is the M10 canonical-event-driven Benchwork Rite. It
...
The pinned `computational-study@0.1.0` definition remains readable for legacy
ledgers.
