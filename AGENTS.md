...
- Do not seal an RQ, Protocol, or Decision without explicit user confirmation.
- Preserve failed and negative Runs.
- Do not claim a Provider result is an accepted scientific fact until Athanor returns a Receipt.
